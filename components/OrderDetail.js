                ...
                orderDetail.map(order => (
                    <div key={order._id} style={{ margin: '20px auto' }} className="row justify-content-around">
                        <div className="text-uppercase my-3">
                            ...
                            <div className="mt-4 text-secondary" style={{ maxWidth: '600px' }}>
                                <h5>Shipping</h5>
                                <p>Name: {order.user.name}</p>
                                <p>Email: {order.user.email}</p>
                                <p>Address: {order.address}</p>
                                <p>Moblie: {order.mobile}</p>
                    ...
                    d-flex justify-content-between align-items-center`} role='alert'>
                                ...
                                <div>
                                    ...
                                    {
                                        order.cart.map(item => (
                                            <div key={item._id} className="row border-bottom mx-0 p-2 justify-content-between align-items-center"
                        ...
                        </div>
                        {
                            ...
                            <div className="p-4">
                                <h3 className="m-4 text-uppercase">Total: ${order.total}</h3>
