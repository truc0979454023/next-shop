...
const Cart = () => {
    ...
    useEffect(() => {
        const cartLocal = JSON.parse(localStorage.getItem('__next__cart01__demo'))
    ...
    if (cart.length === 0) return <img className="img-responsive w-100" src="/empty-cart.png" alt="not empty" />
    return (
        <div className="row mx-auto">
            ...
            <div className="col-md-4 my-3 text-right text-uppercase text-secondary">
                ...
                <Link href={auth.user ? '#!' : '/signin'}>
                    <a className="btn btn-dark my-2 w-100" onClick={handleOrders}>Order And Payment </a>
                </Link>
