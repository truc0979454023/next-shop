...
const Profile = () => {
    ...
    const changeAvatar = e => {
        ...
        if (file.size > 1024 * 1024)//1mb
            return dispatch({ type: 'NOTIFY', payload: { error: "The largest image is 1mb." } })
        ...
        <div className="profile_page">
            ...
            <section className="row text-secondary my-3">
                <div className="col-md-4"
                    ...
                    <button className="btn btn-info w-100" disabled={notify.loading} onClick={handleUploadProfile}>
                        Update
                    </button>
